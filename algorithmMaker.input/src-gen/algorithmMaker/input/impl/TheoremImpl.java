 ...
 * </p>
 * <ul>
 *   <li>{@link algorithmMaker.input.impl.TheoremImpl#getContent <em>Content</em>}</li>
...
public class TheoremImpl extends MinimalEObjectImpl.Container implements Theorem
{
  ...
  public NotificationChain basicSetContent(Property newContent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InputPackage.THEOREM__CONTENT, oldContent, newContent);
  ...
  public void setContent(Property newContent)
  {
    if (newContent != content)
    {
      ...
      if (content != null)
        msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - InputPackage.THEOREM__CONTENT, null, msgs);
      if (newContent != null)
        msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - InputPackage.THEOREM__CONTENT, null, msgs);
      msgs = basicSetContent(newContent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.THEOREM__CONTENT, newContent, newContent));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InputPackage.THEOREM__CONTENT:
  ...
  public boolean eIsSet(int featureID)
  {
	...
	public int hashCode() {
		...
		ret += content == null ? 0 :content.hashCode();
	...
	public String toString() {
		...
		ret.append(content.toString() + ":::" + '"' + description + '"');
		return ret.toString();
	}
