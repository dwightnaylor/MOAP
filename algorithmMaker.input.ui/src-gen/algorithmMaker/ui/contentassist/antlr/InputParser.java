		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSugarAdditionAccess().getSymbolAlternatives_1_1_0(), "rule__SugarAddition__SymbolAlternatives_1_1_0");
					put(grammarAccess.getSugarMultiplicationAccess().getSymbolAlternatives_1_1_0(), "rule__SugarMultiplication__SymbolAlternatives_1_1_0");
					put(grammarAccess.getSugarNumericalPrimaryAccess().getAlternatives(), "rule__SugarNumericalPrimary__Alternatives");
					...
					put(grammarAccess.getSugarAdditionAccess().getGroup(), "rule__SugarAddition__Group__0");
					...
					put(grammarAccess.getSugarAdditionAccess().getSymbolAssignment_1_1(), "rule__SugarAddition__SymbolAssignment_1_1");
