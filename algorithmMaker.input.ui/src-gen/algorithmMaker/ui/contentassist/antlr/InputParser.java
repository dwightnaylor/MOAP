		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProblemColonAccess().getGroup(), "rule__ProblemColon__Group__0");
					put(grammarAccess.getProblemColonAccess().getGroup_1(), "rule__ProblemColon__Group_1__0");
					...
					put(grammarAccess.getProblemColonAccess().getVarsAssignment_0(), "rule__ProblemColon__VarsAssignment_0");
					put(grammarAccess.getProblemColonAccess().getVarsAssignment_1_1(), "rule__ProblemColon__VarsAssignment_1_1");
					put(grammarAccess.getProblemColonAccess().getPropertyAssignment_3(), "rule__ProblemColon__PropertyAssignment_3");
					...
					put(grammarAccess.getImplicationAccess().getImplicationAssignment_1_1(), "rule__Implication__ImplicationAssignment_1_1");
					...
					put(grammarAccess.getTheoremAccess().getContentAssignment_0(), "rule__Theorem__ContentAssignment_0");
					put(grammarAccess.getTheoremAccess().getDescriptionAssignment_2(), "rule__Theorem__DescriptionAssignment_2");
